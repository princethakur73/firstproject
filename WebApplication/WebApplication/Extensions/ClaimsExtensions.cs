...
namespace WebApplication.Extensions
{
    public static class ClaimsExtensions
    {
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WebApplication.ViewModels.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WebApplication.ViewModels.RegisterViewModel.Name")?.Value;
        }
