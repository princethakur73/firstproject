...
$(document).ready(function () {
    ...
    $.get('/Admin/Gallery/GetGalleryList', { 'pageNumber': 1, 'pageSize': 10 }, function (data) {
...
$(document).on('click', 'table > tbody > tr > td > .pull-right > .delete', function () {
    ...
    if (a) {
        ...
        $.get('/Admin/Gallery/delete', { "Id": id }, function (data) {
            if (data == true) {
...
$(document).on('click', 'li > a', function () {
    ...
    $.get('/Admin/Gallery/GetGalleryList', { 'pageNumber': parseInt(pageNo), 'pageSize': 10 }, function (data) {
        var templateResult = templateCompile(data);
        $('#table').html(templateResult);
    });
