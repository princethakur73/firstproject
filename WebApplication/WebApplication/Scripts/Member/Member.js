...
$(document).ready(function () {
    ...
    $.get('/Admin/Member/GetMemberList', { 'pageNumber': 1, 'pageSize': 10 }, function (data) {
        console.log(data);
...
$(document).on('click', 'li > a', function () {
    ...
    $.get('/Admin/Member/GetMemberList', { 'pageNumber': parseInt(pageNo), 'pageSize': 10 }, function (data) {
        var templateResult = templateCompile(data);
        $('#table').html(templateResult);
    });
