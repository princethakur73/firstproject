...
$(document).ready(function () {
    ...
    $.get('/Admin/DepartmentMaster/GetDepartmentList', { 'pageNumber': 1, 'pageSize': 10 }, function (data) {
        console.log(data);
...
$(document).on('click', 'table > tbody > tr > td > .pull-right > .delete', function () {
    ...
    if (a) {
        ...
        $.get('/Admin/DepartmentMaster/delete', { "Id": id }, function (data) {
            if (data == true) {
...
$(document).on('click', 'li > a', function () {
    ...
    $.get('/Admin/DepartmentMaster/GetDeaprtmentList', { 'pageNumber': parseInt(pageNo), 'pageSize': 10 }, function (data) {
        var templateResult = templateCompile(data);
        $('#table').html(templateResult);
    });
