...
namespace WebApplication.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            var result = await UserManager.ConfirmEmailAsync(Int64.Parse(userId), code);
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var AppMember = new ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        public ActionResult LogOff()
        {
            ...
            MenuList += "-" + _currentUser.User.Id.ToString();
            UserDetail += "-" + _currentUser.User.Id.ToString();
